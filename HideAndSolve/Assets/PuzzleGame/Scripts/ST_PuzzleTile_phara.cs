...
public class ST_PuzzleTile_phara : MonoBehaviour
{
    // 현재 타일의 위치 저장을 위한 변수
    ...
    public void ExecuteAdditionalMove()
    {
        ...
        LaunchPositionCoroutine(this.transform.parent.GetComponent<ST_PuzzleDisplay_phara>().GetTargetLocation(this.GetComponent<ST_PuzzleTile_phara>()));
    }
