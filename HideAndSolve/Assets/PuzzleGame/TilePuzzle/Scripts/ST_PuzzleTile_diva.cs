...
public class ST_PuzzleTile_diva : MonoBehaviour {
    ...
    public void ExecuteAdditionalMove()
    {
        ...
        LaunchPositionCoroutine(this.transform.parent.GetComponent<ST_PuzzleDisplay_diva>().GetTargetLocation(this.GetComponent<ST_PuzzleTile_diva>()));
    }
